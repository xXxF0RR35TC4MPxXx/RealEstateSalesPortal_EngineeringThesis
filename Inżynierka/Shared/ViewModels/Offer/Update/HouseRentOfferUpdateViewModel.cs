...
{
    public class HouseRentOfferUpdateViewModel : OfferUpdateViewModel
    {
        ...
        [Range(1, Int32.MaxValue, ErrorMessage = "Liczba pięter nie może być ujemna")]
        ...
        [Required]
        [Range(1, Int32.MaxValue, ErrorMessage = "Kwota nie może być ujemna")]
