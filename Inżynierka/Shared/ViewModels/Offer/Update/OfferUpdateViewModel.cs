...
{
    public abstract class OfferUpdateViewModel
    {
        ...
        [Required(ErrorMessage = "Status oferty jest wymagany")]
        public OfferStatus OfferStatus { get; set; } //status oferty (nowa, zarezerwowana, zakończona)
    }
}
