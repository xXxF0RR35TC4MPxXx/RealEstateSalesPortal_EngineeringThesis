...
{
    public class ApartmentRentOfferUpdateViewModel : OfferUpdateViewModel
    {
        ...
        [Range(1, Int32.MaxValue, ErrorMessage = "Liczba pokoi nie może być mniejsza od 1!")]
        public int? RoomCount { get; set; }

        [Range(1, Int32.MaxValue, ErrorMessage = "Powierzchnia nie może być mniejsza od 1!")]
