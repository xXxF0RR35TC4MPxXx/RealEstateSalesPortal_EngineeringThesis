...
{
    public class RoomRentingOfferCreateViewModel : OfferCreateViewModel
    {
        [Range(0, Int32.MaxValue, ErrorMessage = "Kwota nie może być ujemna")]
        public int? AdditionalFees { get; set; } //opłaty dodatkowe

        [Range(0, Int32.MaxValue, ErrorMessage = "Kaucja nie może być ujemna")]
        public int? Deposit { get; set; } //kaucja

        [Range(0, Int32.MaxValue, ErrorMessage = "Liczba współlokatorów nie może być ujemna")]
