...
{
    public class GarageSaleReadOfferDTO : ReadOfferDTO
    {
        ...
        public GarageSaleReadOfferDTO(string offerTitle, int price, string sellerType,
