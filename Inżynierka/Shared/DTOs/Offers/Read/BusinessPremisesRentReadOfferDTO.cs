...
{
    public class BusinessPremisesRentReadOfferDTO : ReadOfferDTO
    {
        ...
        public BusinessPremisesRentReadOfferDTO(string offerTitle, int price, string sellerType,
        ...
        public BusinessPremisesRentReadOfferDTO()
        {
        }
    }
}
