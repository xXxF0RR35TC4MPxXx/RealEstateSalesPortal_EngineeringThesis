...
{
    public class ApartmentSaleReadOfferDTO : ReadOfferDTO
    {
        ...
        public ApartmentSaleReadOfferDTO(string offerTitle, int price, string sellerType,
            ...
            bool? stove, bool? oven, bool? tV, string? typeOfMarket, string? formOfProperty, string? apartmentFinishCondition)
        {
        ...
        public ApartmentSaleReadOfferDTO()
        {
        }
    }
}
