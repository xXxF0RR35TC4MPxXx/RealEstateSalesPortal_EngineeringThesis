...
{
    public class HallSaleOfferCreateDTO : OfferCreateDTO
    {
        ...
        public HallSaleOfferCreateDTO(string offerTitle, int price, string sellerType,
