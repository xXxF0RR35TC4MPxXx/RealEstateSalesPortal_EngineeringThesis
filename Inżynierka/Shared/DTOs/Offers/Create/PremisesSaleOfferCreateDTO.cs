...
{
    public class PremisesSaleOfferCreateDTO : OfferCreateDTO
    {
        ...
        public PremisesSaleOfferCreateDTO(string offerTitle, int price, string sellerType,
        ...
        public PremisesSaleOfferCreateDTO()
        {
        }
    }
}
