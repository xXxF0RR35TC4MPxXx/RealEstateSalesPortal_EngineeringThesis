...
{
    public class HouseRentOfferCreateDTO : OfferCreateDTO
    {
        ...
        public HouseRentOfferCreateDTO(string offerTitle, int price, string sellerType,
        ...
        public HouseRentOfferCreateDTO()
        {
        }
    }
}
