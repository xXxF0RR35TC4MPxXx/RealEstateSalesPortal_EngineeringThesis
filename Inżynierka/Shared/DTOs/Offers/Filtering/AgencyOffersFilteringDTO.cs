...
{
    public class AgencyOffersFilteringDTO : OfferFilteringDTO
    {
        ...
        public AgencyOffersFilteringDTO(string? city, int? minPrice, int? maxPrice, HowRecent? howRecent,
        ...
        public AgencyOffersFilteringDTO()
        {
