...
{
    public class PremisesSaleFilteringDTO : OfferFilteringDTO
    {
        ...
        public PremisesSaleFilteringDTO(string? city, int? minPrice, int? maxPrice, HowRecent? howRecent, 
            ...
            int? minArea, int? maxArea, int? minPricePerMeterSquared, int? maxPricePerMeterSquared, int? minRoomCount, int? maxRoomCount, IList<Floor>? acceptableFloors, 
            bool? isService, bool? isGastronomic, bool? isOffice, bool? isIndustrial, bool? isCommercial, bool? isHotel, bool? hasShopwindow, bool? hasParkingSpace,
        ...
        public PremisesSaleFilteringDTO()
        {
            RemoteControl = true;
