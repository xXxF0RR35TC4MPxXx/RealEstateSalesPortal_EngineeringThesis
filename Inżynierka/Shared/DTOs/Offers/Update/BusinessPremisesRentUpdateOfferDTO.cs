...
{
    public class BusinessPremisesRentUpdateOfferDTO:OfferUpdateDTO
    {
        ...
        public BusinessPremisesRentUpdateOfferDTO(string offerTitle, int price, 
            string voivodeship, string city, string address, string description, bool? remoteControl, string offerStatus,

            PremisesLocation? location, Floor? floor, int? yearOfConstruction, PremisesFinishCondition? finishCondition, bool? antiBurglaryBlinds,
        ...
        public BusinessPremisesRentUpdateOfferDTO()
        {
        }
    }
}
