...
{
    public class HallSaleUpdateOfferDTO: OfferUpdateDTO
    {
        ...
        public HallSaleUpdateOfferDTO(string offerTitle, int price,
            ...
            bool? pavedDriveway, bool? asphaltDriveway, TypeOfMarket? typeOfMarket, int? area)
        {
