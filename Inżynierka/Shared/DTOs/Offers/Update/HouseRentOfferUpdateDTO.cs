...
{
    public class HouseRentOfferUpdateDTO : OfferUpdateDTO
    {
        ...
        public HouseRentOfferUpdateDTO(string offerTitle, int price,
            ...
            WindowType? windowsType, Location? location, string? availableFromDate, bool? isARecreationHouse,
        ...
        public HouseRentOfferUpdateDTO()
        {
        }
    }
}
