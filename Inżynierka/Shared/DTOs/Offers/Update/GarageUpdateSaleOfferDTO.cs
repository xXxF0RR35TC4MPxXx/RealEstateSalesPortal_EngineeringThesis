...
{
    public class GarageUpdateSaleOfferDTO:OfferUpdateDTO
    {
        ...
        public GarageUpdateSaleOfferDTO(string offerTitle, int price,
            string voivodeship, string city, string address, string description, bool? remoteControl, string offerStatus,
            GarageConstruction? construction, GarageLocation? location, GarageLighting? lighting, GarageHeating? heating, TypeOfMarket? typeOfMarket)
        {
        ...
        public GarageUpdateSaleOfferDTO()
        {
        }
    }
}
